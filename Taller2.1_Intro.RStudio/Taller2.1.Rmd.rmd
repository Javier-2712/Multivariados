...
#--------------
# 1) Operaciones aritm?ticas básicas
...
class(n.sitios)       # Tipolog?a del Número de sitios
class(dos.sitios)     # Tipolog?a de la sentencia lógica
...
sitios <- c(2, 3, 2, 3)   # Vector sitios
names(sitios) <- c("dos", "tres", "dos", "dos")   # Nombres de los elementos del vector sitios
...
plot(sqrt(Matriz2))   # Figura con transformación cuadrítica
...
plot(sqrt(Matriz3))   # Figura con transformación cuadrítica
```
